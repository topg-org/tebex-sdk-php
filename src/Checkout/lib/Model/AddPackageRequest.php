...
/**
 * AddPackageRequest Class Doc Comment
 *
 * @category Class
 * @package  TebexCheckout
 * @author   OpenAPI Generator team
 ...
 */
class AddPackageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addPackage_request';
    ...
    */
     ...
     * Sets qty
     *
     * @param int|null $qty The quantity of `package` in this basket. This is not the total quantity of overall items in the basket.
     *
     * @return self
     */
     ...
     * Sets revenue_share
     *
     * @param \TebexCheckout\Model\RevenueShare[]|null $revenue_share An array of payment destination objects describing how the purchase should be split between multiple wallets. **Only available with pre-agreement from Tebex.**
     *
     * @return self
     */
