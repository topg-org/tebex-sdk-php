...
/**
 * RecurringPaymentLinks Class Doc Comment
 *
 * @category Class
 * @package  TebexCheckout
 * @author   OpenAPI Generator team
 ...
 */
class RecurringPaymentLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecurringPayment_links';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payment_history', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $initial_payment initial_payment
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $payment_history payment_history
     *
     * @return self
     */
    public function setPaymentHistory($payment_history)
    {
        if (is_null($payment_history)) {
            throw new \InvalidArgumentException('non-nullable payment_history cannot be null');
        }
