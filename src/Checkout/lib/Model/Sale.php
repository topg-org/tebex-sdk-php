...
class Sale implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the sale (displayed to the customer)
     *
     * @return self
     */
     ...
     * Sets discount_type
     *
     * @param string|null $discount_type The type of discount, either `percentage` for deducting a percentage of each item, or `amount` to deduct a fixed amount from each item.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The amount or percentage to deduct
     *
     * @return self
     */
