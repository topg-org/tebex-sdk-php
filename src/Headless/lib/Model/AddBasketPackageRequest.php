...
/**
 * AddBasketPackageRequest Class Doc Comment
 *
 * @category Class
 * @package  TebexHeadless
 * @author   OpenAPI Generator team
 ...
 */
class AddBasketPackageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addBasketPackage_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('target_username_id', $data ?? [], null);
    }
